...
def image(url: str, width: int | None = None, height: int | None = None) -> str:
    """Markdown image with optional dimensions.

    Dimensions are stored as HTML attributes for the formatter to handle.
    """
    if width and height:
