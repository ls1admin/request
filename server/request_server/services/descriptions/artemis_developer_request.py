...
class ArtemisDevDescriptionBuilder:
    ...
    def _build_csv_import_line(
        ...
        return f"{tumid},{first_name},{last_name},{email},{artemis_request.github_username},{artemis_request.slack_email},{csv_teams},False,False,True,False,False,False,False,False,False,False,False,False"
